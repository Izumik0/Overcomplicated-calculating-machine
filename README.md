...
komenda: python SMM.py -p [plik .pdb na podstawie którego robiono symulacje] -t [trajektoria .xtc z symulacji] -w [plik .gro z symulacji] -n [Plik z więzami] -o [output]
